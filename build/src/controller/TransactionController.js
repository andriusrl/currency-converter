        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, new TransactionBusiness_1.TransactionBusiness(new TransactionDatabase_1.TransactionDatabase).createTransaction(req.body.id, req.body.origin, req.body.value, req.body.destiny, req.body.date)];
                    case 1:
                        result = _a.sent();
